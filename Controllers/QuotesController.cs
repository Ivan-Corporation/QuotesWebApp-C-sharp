...
namespace QuotesWebApp.Controllers
{
    public class QuotesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Quotes,QuotesAuthor")] Quote quote)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Quotes,QuotesAuthor")] Quote quote)
        {
            if (id != quote.Id)
            {
                return NotFound();
